...
9.  Verify the publishing
    ...
    * Verify that the new version is available on PyPI at
      https://pypi.python.org/pypi/zhmc-log-forwarder/
    ...
    * Verify that the new version has documentation on ReadTheDocs at
      https://zhmc-log-forwarder.readthedocs.io/en/latest/changes.html
      ...
      https://readthedocs.org/projects/zhmc-log-forwarder/versions/
