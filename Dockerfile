# Dockerfile for zhmc-log-forwarder project
#
# This image runs the zhmc_log_forwarder command.
#
# The log forwarder config file needs to be made available to the container
...
# Path name of binary distribution archive of zhmc-log-forwarder package
ARG bdist_file
...
# Version of the zhmc-log-forwarder package
ARG package_version
...
# Git commit ID of the zhmc-log-forwarder repo used to build the image
ARG git_commit
RUN : "${git_commit:?Build argument git_commit is required}"

# Set image metadata
LABEL org.opencontainers.image.title="IBM Z HMC Log Forwarder"
LABEL org.opencontainers.image.version="${package_version}"
LABEL org.opencontainers.image.authors="Andreas Maier"
LABEL org.opencontainers.image.created="${build_date}"
LABEL org.opencontainers.image.url="https://github.com/zhmcclient/zhmc-log-forwarder"
LABEL org.opencontainers.image.documentation="https://zhmc-log-forwarder.readthedocs.io"
LABEL org.opencontainers.image.source="https://github.com/zhmcclient/zhmc-log-forwarder"
